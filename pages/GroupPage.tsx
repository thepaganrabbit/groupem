...
import { View, Text, ToastAndroid, ActivityIndicator, StyleSheet, ScrollView, Button } from 'react-native';
        ...
        <View>
            ...
            <View style={{marginTop: 15}}>
                ...
                <Table borderStyle={{borderWidth: 2, borderColor: '#c8e1ff'}}>
                    <Row data={tableData.heads} style={styles.head} />   
                    <TableWrapper>
                    <Rows data={tableData.rows} style={{padding: 3}} />
                    </TableWrapper>
                </Table>
